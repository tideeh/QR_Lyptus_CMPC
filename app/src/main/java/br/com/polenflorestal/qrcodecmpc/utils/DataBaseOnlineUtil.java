...
public final class DataBaseOnlineUtil {
    private static DataBaseOnlineUtil INSTANCE = null;
    private FirebaseFirestore db = null;

    private DataBaseOnlineUtil(){
        if(db == null) {
    ...
    public static DataBaseOnlineUtil getInstance(){
        if(INSTANCE == null)
            INSTANCE = new DataBaseOnlineUtil();
        return INSTANCE;
    }
    ...
    public Query getCollectionReference(String collection){
    ...
    public Query getCollectionReferenceWhereEqualTo(String collection, String whereKey, Object whereValue){
        return db.collection(collection).whereEqualTo(whereKey, whereValue);
    }

    public Query getCollectionReferenceWhereEqualTo(String collection, String whereKey, Object whereValue, String orderBy, Query.Direction direction){
        return db.collection(collection).whereEqualTo(whereKey, whereValue).orderBy(orderBy, direction);
    }
